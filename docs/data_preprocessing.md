...
总分 100 分：追溯字段 5、核心字段 10、地点限制 5、描述完整性 25、薪资透明度 15、技能清晰度 20、职级 10、时效性 5、类别 5。描述长度和技能数采用分段递增并设上限，防止单一“是/否”字段决定标签。`quality_score >= 80` 定义为高信息质量。当前分布为 High 6,071、Medium 5,855、Low 74。
